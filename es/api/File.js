...
import { CACHE_PREFIX_FILE, ERROR_CODE_FETCH_FILE, ERROR_CODE_GET_DOWNLOAD_URL, FIELD_AUTHENTICATED_DOWNLOAD_URL, FIELD_EXTENSION, FIELD_IS_DOWNLOAD_AVAILABLE, X_REP_HINTS } from '../constants';
import Item from './Item';
import TokenService from '../utils/TokenService';

var File = /*#__PURE__*/function (_Item) {
  ...
  _createClass(File, [{
    ...
    key: "getThumbnailUrl",
    value: function () {
      var _getThumbnailUrl = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(item) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 8:
                ...
                return _context2.abrupt("return", "".concat(thumbnailBaseUrl, "?").concat(thumbnailUrlQuery));
    ...
    value: function setFileDescription(file, description, successCallback, errorCallback) {
      ...
      return this.xhr.put({
        ...
        if (!_this.isDestroyed()) {
          var updatedFile = _this.merge(_this.getCacheKey(id), 'description', data.description);

          successCallback(updatedFile);
        }
      }).catch(function () {
        if (!_this.isDestroyed()) {
          var originalFile = _this.merge(_this.getCacheKey(id), 'description', file.description);
    ...
    key: "getFile",
    value: function () {
      var _getFile = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(id, successCallback, errorCallback) {
        var options,
            cache,
            key,
            isCached,
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 21:
                _yield$this$xhr$get = _context3.sent;
