...
var TasksNew = /*#__PURE__*/function (_TasksBase) {
  _inherits(TasksNew, _TasksBase);

  var _super = _createSuper(TasksNew);
  ...
  _createClass(TasksNew, [{
    ...
    key: "getUrlForTaskCreate",
    value: function getUrlForTaskCreate() {
      return "".concat(this.getBaseApiUrl(), "/undoc/tasks");
    }
  }, {
    key: "getUrlForTask",
    ...
    key: "createTask",
    value: function createTask(_ref) {
    ...
    key: "updateTask",
    value: function updateTask(_ref2) {
    ...
    key: "deleteTask",
    value: function deleteTask(_ref3) {
    ...
    key: "getTasksForFile",
    value: function getTasksForFile(_ref4) {
