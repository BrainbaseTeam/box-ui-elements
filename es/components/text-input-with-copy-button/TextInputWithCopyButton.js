...
var defaultCopyText = /*#__PURE__*/React.createElement(FormattedMessage, messages.copy);
var defaultCopiedText = /*#__PURE__*/React.createElement(FormattedMessage, messages.copied);

var TextInputWithCopyButton = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(TextInputWithCopyButton, _React$PureComponent);

  var _super = _createSuper(TextInputWithCopyButton);
  ...
  function TextInputWithCopyButton(props) {
    ...
    _this = _super.call(this, props); // $FlowFixMe https://github.com/facebook/flow/issues/4335
    ...
    _defineProperty(_assertThisInitialized(_this), "renderCopyButton", function () {
      return _this.isCopyCommandSupported ? /*#__PURE__*/React.createElement(Button, _extends({
