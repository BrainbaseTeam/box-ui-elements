...
declare const _default: React.ForwardRefExoticComponent<Pick<TimeInputProps, "className" | "label" | "onError" | "onBlur" | "onChange" | "hideLabel" | "errorTooltipPosition" | "isRequired" | "initialDate" | "innerRef"> & {
