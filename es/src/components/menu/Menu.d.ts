...
declare class Menu extends React.Component<MenuProps> {
    ...
    getMenuItemElFromEventTarget: (target: Node) => {
        menuItemEl?: HTMLElement | null | undefined;
        menuIndex: number;
    };
    ...
    fireOnCloseHandler: (isKeyboardEvent?: boolean | undefined, event?: React.KeyboardEvent<HTMLElement> | React.MouseEvent<HTMLUListElement, MouseEvent> | undefined) => void;
