...
declare type OtherTooltipProps = Omit<TooltipProps, 'text'>;
export declare type ImageTooltipProps = {
...
declare const ImageTooltip: ({ children, className, content, image, title, ...otherTooltipProps }: ImageTooltipProps) => JSX.Element;
