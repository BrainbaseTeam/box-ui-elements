...
var errorMap = (_errorMap = {}, _defineProperty(_errorMap, VALUE_MISSING, /*#__PURE__*/React.createElement(FormattedMessage, commonMessages.requiredFieldError)), _defineProperty(_errorMap, TYPE_MISMATCH, /*#__PURE__*/React.createElement(FormattedMessage, commonMessages.invalidURLError)), _errorMap);

var EditableURL = /*#__PURE__*/function (_React$Component) {
  _inherits(EditableURL, _React$Component);

  var _super = _createSuper(EditableURL);
