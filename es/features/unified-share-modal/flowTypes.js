...
import * as constants from './constants'; // DRY: Invert the constants so that we can construct the appropriate enum types
...
var permissionLevelValues = (_permissionLevelValue = {}, _defineProperty(_permissionLevelValue, constants.CAN_VIEW_DOWNLOAD, 'CAN_VIEW_DOWNLOAD'), _defineProperty(_permissionLevelValue, constants.CAN_VIEW_ONLY, 'CAN_VIEW_ONLY'), _permissionLevelValue);
